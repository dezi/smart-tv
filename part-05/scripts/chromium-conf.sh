...
GYP_DEFINES="$GYP_DEFINES google_api_key='AIzaSyCkfPOPZXDKNn8hhgu3JrA62wIgC93d44k'"
GYP_DEFINES="$GYP_DEFINES google_default_client_id='811574891467.apps.googleusercontent.com'"
GYP_DEFINES="$GYP_DEFINES google_default_client_secret='kdloedMFGdGla2P1zacGjAQh'"
...
# Sandbox definitions
GYP_DEFINES="$GYP_DEFINES linux_sandbox_path=/usr/local/lib/chromium/chromium_sandbox"
GYP_DEFINES="$GYP_DEFINES linux_sandbox_chrome_path=/usr/local/lib/chromium/chromium"
