...
build_libMXF() {
  download_and_unpack_file http://heanet.dl.sourceforge.net/project/libuuid/libuuid-1.0.2.tar.gz "libuuid-1.0.2"
  ...
  cp libuuid-1.0.2/uuid.h libMXF-src-1.0.0/libMXF/lib/include/uuid/uuid.h
  wget https://raw.github.com/dezi/raspi/master/patches/writeavidmxf-main.c
  mv writeavidmxf-main.c libMXF-src-1.0.0/libMXF/examples/writeavidmxf/main.c; \
  cd libMXF-src-1.0.0
